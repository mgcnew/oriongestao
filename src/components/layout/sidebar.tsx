...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'relative flex flex-col h-[calc(100vh-2rem)] my-4 ml-4 mr-2 bg-sidebar border border-sidebar-border shadow-2xl transition-all duration-300 ease-in-out shrink-0 rounded-3xl overflow-hidden',
        collapsed ? 'w-20' : 'w-72'
      )}
    >
      {/* Logo */}
      ...
      {/* User Card */}
      <div className={cn("px-3 py-4 border-t border-sidebar-border transition-all duration-300", collapsed ? "items-center" : "")}>
